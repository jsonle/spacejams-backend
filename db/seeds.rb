...
Room.create(playlist_name: "Today's Top Hits", playlist_id: "37i9dQZF1DX9OZisIoJQhG", playlist_image_url: morning_classical.images[0]['url'], playlist_description: morning_classical.description)
